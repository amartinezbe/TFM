#creacion fichero de trabajo global
#creacion de variables de trabajo recodificandolas 
#las variables ordinales pasan a tener valores numericos
#las variables con datos como no sabe no contesta pasa a ser NA

#al final creo el fichero de españa como selección de las variables globales ya modificadas
...
#creación fichero de trabajo global con las variables recodificadas,
...
#
#sustituir DK/NA y DK (SPONT.) por NA
...
#convierto la variable d4 (fin estudios a factor)
#No uso de momento
#global <- within(global, {
#  d4_F <- d4 
#})
...
#recodifico la variable d4r1 y d4r2 eliminado los refusal.
#de momento d4r1 no la recodifico
#global <- within(global, {
#  d4r1NA <- Recode(d4r1, "c(\"DK\" ) =  NA;c( \"Refusal\" ) =  NA", 
#                   as.factor = TRUE)
#})
...
#global <- within(global, q4_2NA!="NA")

#Reclasificacion de la variable q4_1, q4_2, q2, q3 en q4_1, q4_2, q2, q3
#creo variables ordinales mediante la funcion facotr ordered = true
...
#reclasifica q1_1 ... q1_6 en q1_1 ... q1_6
#creo variables ordinales con factor n?mero
...
#reclasifica las sd3 creando a variable suma_sd3 para poder trabajarla
#creo variables ordinales con factor n?mero
...
#reclasifica las sd1 creando a variable suma_sd1 para poder trabajarla
#creo variables ordinales con factor n?mero
#solo seleccion redes sociales e internet
...
global$idgov <- as.numeric(as.character(global$idgov))

save("global", file = "global.RData")

#creaci?n variable ideologia gobierno comunidad autonoma
global <- within(global, {
...
#creación del fichero de trabajo de españa
save("global", file = "global.RData")

ES <- filter(global, isocntry == "ES")

ES$idcom <- as.numeric(as.character(ES$idcom))
